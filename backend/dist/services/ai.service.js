...
exports.regenerateMeal = regenerateMeal;
...
async function generateModule(moduleType, context) {
    const ai = getClient();
...
async function regenerateMeal(context, dayIndex, mealType, currentMealPlan) {
    const ai = getClient();
...
function buildModulePrompt(moduleType, ctx) {
...
function filterContent(data, goalType) {
