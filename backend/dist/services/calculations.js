 ...
 */
function calculateCalories(stats, goalType, trimester, breastfeeding) {
 ...
 */
function calculateHydration(weightKg, hoursExercisePerWeek = 0, isPhysicalJob = false, isPregnantOrBreastfeeding = false) {
